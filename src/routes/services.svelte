    ...
    <div class="container px-5 py-10 mx-auto flex flex-wrap">
      ...
      <div class="flex-grow bg-gray-200 mx-auto px-5 py-10 items-center justify-center">
        <div class="text-center md:w-2/3 lg:w-full w-full">
          ...
          <p class="leading-relaxed">Find the Right tenant.  Done!</p>
          <p class="leading-relaxed">Keep the Right tenant.  Done!</p>
          <p class="leading-relaxed">Long term property care.  Done!</p>
          <p class="leading-relaxed">Stree free income.  Done!</p>
