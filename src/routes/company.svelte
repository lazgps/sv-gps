        ...
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <p class="mb-4">Todd is a proud graduate of the University of Central Florida and a long-term resident of the Orlando metropolitan area. Todd was lucky enough to graduate UCF and start and continue his career in the Orlando area. This has allowed him to create long lasting relationships in business and with friends in our local area. His experience in the fortune 500 technology industry, including social media and project management, brings a special skill set to GPS. In his spare time Todd enjoys UCF football, travelling, and playing guitar.</p>
              <span class="inline-flex">
                <a class="text-gray-500">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
        ...
        <div class="p-4 lg:w-1/2">
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <h3 class="text-gray-500 mb-3">Designer</h3>
              <p class="mb-4">Doraliz Fernandez was born in Dominican Republic but raised most of her life in central florida. Coming from a very close family, she has learned to value relations both personal and professionally. Her value for family life has helped her develop traits and qualities such as flexibility, compassion, and perseverance which projects in every aspect of her work life. In 2015 she was offered the opportunity to shift occupations from hospitality to property management, working directly with HOA's. The knowledge and years of experience she was able to gain during this time gave her a smooth transition to Real Estate, once she joined the GPS Realty and Property Management family in 2018. During her personal time, Doraliz enjoys spending time with her husband, and their little girl GIanna. When she is not occupied at home, you can find her outdoors searching for the next adventure!</p>
              <span class="inline-flex">
                <a class="text-gray-500">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
