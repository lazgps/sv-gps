...
<footer class="bg-red">
    <div class="container grid grid-cols-2 grid-flow-row justify-items-auto">
        <div class="grid grid-cols-1 grid-flow-row justify-items-auto md:mx-8 md:my-4 md:py-4 md:px-8 text-white">
            <p class="md:mr-6 md:pr-6">838 Grand Regency Pointe</p>
            <p class="md:mr-6 md:pr-6">Altamonte Springs, FL 32714</p>
            <p class="md:mr-6 md:pr-6">407-715-2652</p>
            <p class="md:mr-6 md:pr-6">info@gps-realestate.com</p>
        </div>
